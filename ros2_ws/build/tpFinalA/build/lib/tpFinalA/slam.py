...
class fastslamNode(Node):
    ...
    def publish_segments(self, data, segments):
        """ Visualiza y usa los segmentos extraídos """
        msg = MarkerArray()
        ...
        # >>> aquí actualizás el mapa con esos mismos segmentos <<<
        self.update_map_with_segments(segments)
        self.publish_map()
    ...
    def publish_map(self):
        ...
        grid.info.origin.orientation.w = 1.0  # sin rotación
